#welcome to the brain of Simple Calculator v2. This code is 100% free and opensource. Feel free to do any changes to this. Lastly dont forget to click save ! <note by AK PR>
...
if c == 1 :
	...
	print ("invalid process number {add=1,subtract=2,multiply=3,divide=4}")
elif c < 1 :
	print ("invalid process number {add=1,subtract=2,multiply=3,divide=4}")

print ("Simple Calculator Sesson Finished")